    ...
    return Column(
      children: [
        ...
        Padding(
          ...
          child: TextField(
            onChanged: (query) {
              provider.searchAnime(query, "watched");
            },
            decoration: InputDecoration(
              labelText: "Search Watched Anime",
        ...
        // Anime Grid View
        Expanded(
          child: provider.filteredWatchedList.isEmpty
              ...
              : GridView.builder(
                  ...
                  itemCount: provider.filteredWatchedList.length,
                  itemBuilder: (context, index) {
                    final anime = provider.filteredWatchedList[index]["node"];
                    return Stack(
                      children: [
                        ...
                        Positioned(
                          ...
                          child: IconButton(
                            ...
                            onPressed: () {
                              provider.removeFromWatched(anime["id"]);
                            },
                          ),
                        ),
                      ],
